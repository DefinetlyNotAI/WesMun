            ...
            <section className="pt-32 pb-20 px-4">
                <div className="container mx-auto max-w-4xl animate-in fade-in duration-1000">
                    <div className="text-center mb-12">
                        <h1 className="text-4xl md:text-5xl font-bold mb-4 text-balance">{ContactText.PAGE_TITLE}</h1>
                        <p className="text-lg text-muted-foreground text-pretty">{ContactText.PAGE_SUBTITLE}</p>
                    </div>
                    ...
                    <Card className="bg-card border-border">
                        <CardContent className="p-8 text-center">
                            ...
                            <p className="text-sm text-muted-foreground">{ContactText.SOCIAL_FOLLOW}</p>
                        </CardContent>
                    </Card>
                </div>
            </section>
