                ...
                <div className="container mx-auto animate-in fade-in duration-1000">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        {committees.map((committee) => {
                            ...
                            return (
                                <div key={committee.id} className="cursor-pointer" onClick={() => toggleCommittee(committee.id)}>
                                    <Card className="bg-card border-border overflow-hidden hover:border-primary/50 transition-all h-full">
                                        ...
                                        {isExpanded && (
                                            <CardContent className="p-6 space-y-6">
                                                <div>
                                                    <h4 className="text-sm font-semibold text-foreground mb-2">{CommitteeText.ABOUT_TITLE}</h4>
                                                    <p className="text-sm text-muted-foreground leading-relaxed">{committee.detailedDescription}</p>
                                                </div>

                                                <div>
                                                    <h4 className="text-sm font-semibold text-foreground mb-2">{CommitteeText.TOPICS_TITLE}</h4>
                                                ...
                                                <div className="pt-4 border-t border-border">
                                                    <h4 className="text-sm font-semibold text-foreground mb-3">{CommitteeText.LEADERSHIP_TITLE}</h4>
                                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                        <div className="flex items-center gap-3">
                                                            <Image
                                                                src={committee.chair.image || CommitteeText.PLACEHOLDER_IMAGE}
                                                            ...
                                                            <div>
                                                                ...
                                                                <p className="text-xs text-muted-foreground">{CommitteeText.CHAIR_LABEL}</p>
                                                            </div>
                                                        </div>
                                                        <div className="flex items-center gap-3">
                                                            <Image
                                                                src={committee.viceChair.image || CommitteeText.PLACEHOLDER_IMAGE}
                                                            ...
                                                            <div>
                                                                ...
                                                                <p className="text-xs text-muted-foreground">{CommitteeText.VICE_CHAIR_LABEL}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-4">
                                                    <Button asChild variant="outline" className="h-11 bg-transparent" onClick={(e) => e.stopPropagation()}>
                                                        <a href={committee.backgroundGuidePdf} download>
                                                            <ArrowRight className="mr-2" size={16} />
                                                            {CommitteeText.DOWNLOAD_GUIDE}
                                                        </a>
                                                    </Button>
                                                    <Button asChild className="h-11 bg-primary text-primary-foreground hover:bg-primary/90" onClick={(e) => e.stopPropagation()}>
                                                        <Link href={committee.signupLink} target="_blank">
                                                            {CommitteeText.APPLY_NOW} <ArrowRight className="ml-2" size={16} />
                                                        </Link>
                                                    </Button>
                                                </div>
                                            </CardContent>
