            ...
            <section className="pt-32 pb-20 px-4">
                <div className="container mx-auto animate-in fade-in duration-1000">
                    <div className="text-center mb-12">
                        <h1 className="text-4xl md:text-5xl font-bold mb-4 text-balance">Our Departments</h1>
                        <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
                            Meet the dedicated teams leading WESMUN 2025 to excellence
                        </p>
                    </div>
                        ...
                        {departments.map((department) => (
                            ...
                            >
                                ...
                                <div className="relative h-48 md:h-64 bg-muted">
                                    <Image
                                        src={department.bannerImage || "/placeholder.svg"}
