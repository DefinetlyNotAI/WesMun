...
(self.webpackChunkextract_css = self.webpackChunkextract_css || []).push([[52730], {
    402384: (x, _) => {
        ...
        var L = A;
        _.default = L, x.exports = _.default
    }, 136126: (x, _, A) => {
        var L;
        L = {value: !0};
        var f = A(769078), g = F(A(402384)), M = A(495125);
        ...
        function H(l) {
            for (var v = 1; v < arguments.length; v++) {
                var E = arguments[v] != null ? arguments[v] : {}, q = Object.keys(E);
        ...
        var j = {"commerce-cart": 1, "v7-user-sites": 1, "v7_1-user-sites": 1},
            h = window.Static && window.Static.SQUARESPACE_CONTEXT, D = window.top !== window,
            K = !!h && Object.keys(h).length > 0, V = Object.freeze({[g.default.COMMERCE_CART_V2]: "commerce-cart"});
        ...
        function S() {
            var l = h.websiteSettings, v = l === void 0 ? {} : l;
            return {ampEnabled: !!v.ampEnabled}
        }

        function p() {
            var l = h.collection, v = l === void 0 ? {} : l;
            return {collectionType: v.type || -1}
        }
        ...
        function W(l) {
            var v = V[h.pageType], E = {
                appName: v || "v".concat(l, "-user-sites"),
                context: H({}, C(), b(), S(), p()),
                captureException: (q, N) => {
                    (0, M.withScope)(te => {
                        te.setTag("product_area", "rum-collector"), N !== void 0 && te.setExtra("extras", N), (0, M.captureException)(q)
                    })
                }
            };
            return R(E.appName) && (E.serviceURL = "https://performance.squarespace.com/api/v1/records"), E
        }
        ...
        function A(b, S) {
            for (var p in S) Object.defineProperty(b, p, {enumerable: !0, get: S[p]})
        }
        ...
        var L = () => {
            ...
            for (var p = arguments.length, T = new Array(p > 1 ? p - 1 : 0), R = 1; R < p; R++) T[R - 1] = arguments[R];
            return console.log("[Sentry][".concat(b, "] ").concat(S), ...T), "some-error-identifier"
        }, D = !1, K = b => {
            var S = b.category, p = b.message;
            console.log("[Sentry][addBreadcrumb] (".concat(S, ") ").concat(p))
        }, V = !1;

        function C() {
            return new Proxy({}, {get: () => L})
        }

        window.SQUARESPACE_SENTRY ? (V = !0, f = window.SQUARESPACE_SENTRY.addBreadcrumb, g = window.SQUARESPACE_SENTRY.captureMessage, M = window.SQUARESPACE_SENTRY.captureException, P = window.SQUARESPACE_SENTRY.captureEvent, F = window.SQUARESPACE_SENTRY.configureScope, H = window.SQUARESPACE_SENTRY.withScope, j = window.SQUARESPACE_SENTRY.getCurrentScope) : (console.warn("SENTRY WAS __NOT__ INITIALIZED. Logs will be forwarded to console instead."), f = D ? K : L, g = h("captureMessage"), M = h("captureException"), P = h("captureEvent"), j = C, F = L, H = function () {
            for (var S = arguments.length, p = new Array(S), T = 0; T < S; T++) p[T] = arguments[T];
            var R = p.length === 2 ? p[1] : p[0], W = C();
            return R(W)
        })
    }, 769078: x => {
        function _(t, e) {
        ...
        function S(t, e) {
            if (t) {
                if (typeof t == "string") return _(t, e);
                var n = Object.prototype.toString.call(t).slice(8, -1);
                if (n === "Object" && t.constructor && (n = t.constructor.name), n === "Map" || n === "Set") return Array.from(n);
                if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _(t, e)
            }
        }
        ...
        function p(t, e) {
            ...
            function s(c) {
                ...
                for (; o;) try {
                    if (n = 1, r && (a = c[0] & 2 ? r.return : c[0] ? r.throw || ((a = r.return) && a.call(r), 0) : r.next) && !(a = a.call(r, c[1])).done) return a;
        ...
        var T = Object.defineProperty, R = Object.getOwnPropertyDescriptor, W = Object.getOwnPropertyNames,
            de = Object.prototype.hasOwnProperty, l = function (t, e) {
                return function () {
                    return t && (e = (0, t[W(t)[0]])(t = 0)), e
                }
            }, v = function (t, e) {
                for (var n in e) T(t, n, {get: e[n], enumerable: !0})
            }, E = function (t, e, n, r) {
                if (e && typeof e == "object" || typeof e == "function") {
                    ...
                    try {
                        ...
                        }, s = W(e)[Symbol.iterator](), c; !(a = (c = s.next()).done); a = !0) u()
                    } catch (d) {
                        i = !0, o = d
                    } finally {
                        try {
                ...
                return E(T({}, "__esModule", {value: !0}), t)
            }, N, te = l({
        ...
        var ve, le, Me, Ie, Vt = l({
            "../../node_modules/.pnpm/nanoid@5.0.1/node_modules/nanoid/index.browser.js": function () {
                ...
                te(), ve = function (t) {
                    ...
                    var r = (2 << Math.log(t.length - 1) / Math.LN2) - 1, a = -~(1.6 * r * e / t.length);
                    return function () {
                        for (var i = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : e, o = ""; ;) for (var u = n(a), s = a; s--;) if (o += t[u[s] & r] || "", o.length === i) return o
                    }
                }, Me = function (t) {
        ...
        var Wt = "/api/1/performance/records", zt = "load", ne = "visibilitychange",
            Gt = ["Tab", "ArrowDown", "ArrowLeft", "ArrowRight", "ArrowUp", "End", "Home", "PageDown", "PageUp", " ", "Enter"],
            Xt = "SS_MID", Kt = "SS_ANALYTICS_ID", Jt = 3e4,
            Zt = /(iPhone|iPod|iPad) OS ((1[0-2])|[2-9])_\d+.*AppleWebKit(?!.*Safari)/i, pe = 200, $t = "4.13.1",
            me = function (t) {
                return function () {
                ...
                document.readyState === "complete" ? window.setTimeout(t, 0) : window.addEventListener("pageshow", t, {once: !0})
            }, tn = function () {
                return me(en)
            }, nn = function () {
                var t = {entryType: "navigation", startTime: 0}, e = performance.timing;
                for (var n in e) if (n !== "navigationStart" && n !== "toJSON") {
                    ...
                    return p(this, function (r) {
                        switch (r.label) {
                            case 0:
                                return [4, tn()];
                            case 1:
                                return r.sent(), e = C(window.performance.getEntriesByType("navigation"), 1), n = e[0], [2, n != null ? n : nn()]
                        }
                    })
                });
                return function () {
                    ...
                    return p(this, function (a) {
                        switch (a.label) {
                            case 0:
                                return [4, ge()];
                            case 1:
                                return n = a.sent(), r = n[e], typeof r != "number" || r < 0 || r > 2147483647 ? [2] : [2, Math.round(r)]
                        }
                    })
                });
                return function (n) {
                    ...
                    return p(this, function (a) {
                        switch (a.label) {
                            case 0:
                                return [4, ge()];
                            case 1:
                                return n = a.sent(), r = n[e], typeof r != "string" ? [2] : [2, r]
                        }
                    })
                });
                return function (n) {
                ...
                return Promise.all([Q("domainLookupEnd"), Q("domainLookupStart")]).then(function (e) {
                    var n = C(e, 2), r = n[0], a = n[1];
                    t({domainLookup: he(r, a)})
                })
            }, He = function (t) {
                ...
                try {
                    if (PerformanceObserver.supportedEntryTypes.includes(e)) {
                        ...
                        return a.observe(Object.assign({type: e, buffered: !0}, r || {})), a
                    }
                } catch (i) {
                }
            }, B = function (e, n, r, a) {
                var i, o;
                return function (u) {
                    n.value >= 0 && (u || a) && ((o = n.value - (i || 0)) || i === void 0) && (i = n.value, n.delta = o, n.rating = function (s, c) {
                ...
                n = n || {}, Ee(function () {
                    var r, a = Ze(), i = k("FCP"), o = $("paint", function (u) {
                        u.forEach(function (s) {
                            s.name === "first-contentful-paint" && (o.disconnect(), s.startTime < a.firstHiddenTime && (i.value = Math.max(s.startTime - ze(), 0), i.entries.push(s), r(!0)))
                        })
                    });
                    o && (r = B(e, i, $e, n.reportAllChanges), Z(function (u) {
                        i = k("FCP"), r = B(e, i, $e, n.reportAllChanges), Ge(function () {
                            i.value = performance.now() - u.timeStamp, r(!0)
                        })
                    }))
                })
                ...
                n = n || {}, et(Xe(function () {
                    var r, a = k("CLS", 0), i = 0, o = [], u = function (d) {
                        d.forEach(function (m) {
                            if (!m.hadRecentInput) {
                                var w = o[0], y = o[o.length - 1];
                                i && m.startTime - y.startTime < 1e3 && m.startTime - w.startTime < 5e3 ? (i += m.value, o.push(m)) : (i = m.value, o = [m])
                            }
                        }), i > a.value && (a.value = i, a.entries = o, r())
                    }, s = $("layout-shift", u);
                    s && (r = B(e, a, tt, n.reportAllChanges), ye(function () {
                        u(s.takeRecords()), r(!0)
                    }), Z(function () {
                        i = 0, a = k("CLS", 0), r = B(e, a, tt, n.reportAllChanges), Ge(function () {
                            return r()
                        })
                    }), setTimeout(r, 0))
                }))
            }, ee = {passive: !0, capture: !0}, un = new Date, nt = function (e, n) {
                U || (U = n, J = e, Ye = new Date, at(removeEventListener), rt())
            }, rt = function () {
                if (J >= 0 && J < Ye - un) {
                    var e = {
                ...
                n = n || {}, Ee(function () {
                    var r, a = Ze(), i = k("FID"), o = function (d) {
                        d.startTime < a.firstHiddenTime && (i.value = d.processingStart - d.startTime, i.entries.push(d), r(!0))
                    }, u = function (d) {
                        d.forEach(o)
                    }, s = $("first-input", u);
                    r = B(e, i, it, n.reportAllChanges), s && ye(Xe(function () {
                        u(s.takeRecords()), s.disconnect()
                    })), s && Z(function () {
                        var c;
                        i = k("FID"), r = B(e, i, it, n.reportAllChanges), re = [], J = -1, U = null, at(addEventListener), c = o, re.push(c), rt()
                    })
                })
            }, ot = 0, _e = 1 / 0, ie = 0, fn = function (e) {
                e.forEach(function (n) {
                    n.interactionId && (_e = Math.min(_e, n.interactionId), ie = Math.max(ie, n.interactionId), ot = ie ? (ie - _e) / 7 + 1 : 0)
                })
            }, ut = function () {
                ...
                var n = O[O.length - 1], r = Se[e.interactionId];
                ...
                n = n || {}, Ee(function () {
                    ...
                    var a, i = k("INP"), o = function (c) {
                        c.forEach(function (w) {
                            w.interactionId && dt(w), w.entryType === "first-input" && !O.some(function (y) {
                                return y.entries.some(function (I) {
                                    return w.duration === I.duration && w.startTime === I.startTime
                                })
                            }) && dt(w)
                        });
                        var d, m = (d = Math.min(O.length - 1, Math.floor(ft() / 50)), O[d]);
                        m && m.latency !== i.value && (i.value = m.latency, i.entries = m.entries, a())
                    }, u = $("event", o, {durationThreshold: (r = n.durationThreshold) !== null && r !== void 0 ? r : 40});
                    a = B(e, i, ct, n.reportAllChanges), u && ("PerformanceEventTiming" in window && "interactionId" in PerformanceEventTiming.prototype && u.observe({
                        type: "first-input",
                        buffered: !0
                    }), ye(function () {
                        o(u.takeRecords()), i.value < 0 && ft() > 0 && (i.value = 0, i.entries = []), a(!0)
                    }), Z(function () {
                        O = [], st = ut(), i = k("INP"), a = B(e, i, ct, n.reportAllChanges)
                    }))
                })
            }, be = function () {
                return window.performance && performance.getEntriesByType && performance.getEntriesByType("navigation")[0]
                ...
                try {
                    for (; e && e.nodeType !== 9;) {
                        ...
                        if (r.length + i.length > (n || 100) - 1) return r || i;
                        if (r = r ? i + ">" + r : i, a.id) break;
                        e = a.parentNode
                    }
                } catch (o) {
                }
                ...
                document.visibilityState === "hidden" && G > -1 && (G = e.type === "visibilitychange" ? e.timeStamp : 0, En())
            }, wt = function () {
                ...
                return G < 0 && (G = ht(), wt(), lt(function () {
                    setTimeout(function () {
                        G = ht(), wt()
                    }, 0)
                })), {
                ...
                (function (r, a) {
                    a = a || {}, Sn(function () {
                        var i, o = _n(), u = mt("LCP"), s = function (w) {
                            var y = w[w.length - 1];
                            y && y.startTime < o.firstHiddenTime && (u.value = Math.max(y.startTime - pt(), 0), u.entries = [y], i())
                        }, c = gn("largest-contentful-paint", s);
                        if (c) {
                            i = gt(r, u, yt, a.reportAllChanges);
                            var d = yn(function () {
                                Te[u.id] || (s(c.takeRecords()), c.disconnect(), Te[u.id] = !0, i(!0))
                            });
                            ["keydown", "click"].forEach(function (m) {
                                ...
                                u = mt("LCP"), i = gt(r, u, yt, a.reportAllChanges), hn(function () {
                                    u.value = performance.now() - m.timeStamp, Te[u.id] = !0, i(!0)
                                })
                            })
                        }
                    })
                    ...
                    (function (a) {
                        if (a.entries.length) {
                            var i = be();
                            if (i) {
                                var o = i.activationStart || 0, u = a.entries[a.entries.length - 1],
                                    s = u.url && performance.getEntriesByType("resource").filter(function (I) {
                                        return I.name === u.url
                                    })[0], c = Math.max(0, i.responseStart - o),
                                    d = Math.max(c, s ? (s.requestStart || s.startTime) - o : 0),
                                    m = Math.max(d, s ? s.responseEnd - o : 0), w = Math.max(m, u ? u.startTime - o : 0),
                                    y = {
                                ...
                                return u.url && (y.url = u.url), s && (y.lcpResourceEntry = s), void (a.attribution = y)
                            }
                        }
                        a.attribution = {
                            timeToFirstByte: 0,
                ...
                if (n === "IMG") {
                    ...
                    if (a) return "unknown-imageloader"
                }
                ...
                n += t.tagName;
                var r = t, a = -1;
                do r = r.previousElementSibling, a += 1; while (r !== null);
                n += "[" + a + "]";
                ...
                var e = Et(t);
                if (e.length > pe) return _t(e);
                for (var n = t.parentElement; n !== null && n.tagName !== "BODY";) {
                    var r = "<" + Et(n);
                    if (e += r, e.length > pe) return _t(e);
                    n = n.parentElement
                }
                return e
            }, Cn = function (t) {
            ...
            Pn = ["initiatorType", "nextHopProtocol"], Lt = function (t, e) {
                return function () {
                    var n = g(function (r) {
                        var a, i, o, u, s;
                        return p(this, function (c) {
                            switch (c.label) {
                                case 0:
                                    return c.trys.push([0, 2, , 3]), a = [{}, r], [4, t(r)];
                                case 1:
                                    return e.apply(void 0, [M.apply(void 0, a.concat([c.sent()]))]), [3, 3];
                                case 2:
                                    return i = c.sent(), (s = window) === null || s === void 0 || (u = s.SQUARESPACE_SENTRY) === null || u === void 0 || (o = u.captureException) === null || o === void 0 || o.call(u, i), [3, 3];
                                case 3:
                                    return [2]
                            }
                        })
        ...
        function Ae(t) {
                    ...
                    return p(this, function (u) {
                        switch (u.label) {
                            ...
                            case 1:
                                return u.sent(), [3, 3];
                            case 2:
                                return r = u.sent(), (o = window) === null || o === void 0 || (i = o.SQUARESPACE_SENTRY) === null || i === void 0 || (a = i.captureException) === null || a === void 0 || a.call(i, r), [3, 3];
                            case 3:
                                return [2]
                        }
                    })
            ...
            }()), Ln.forEach(Lt(Q, t)), Pn.forEach(Lt(Be, t))
        }

        var Rn = ["more", "less", "custom"], Nn = function () {
            var t;
            ...
            var e = Pt(), n = function () {
                ...
                var o;
                ["INPUT", "TEXTAREA"].includes((o = i.target) === null || o === void 0 ? void 0 : o.tagName) || !Gt.includes(i.key) || (e.keyboardUsage = !0, document.removeEventListener("keydown", r))
            };
            document.addEventListener("keydown", r);
            var a = function () {
                document.visibilityState === "hidden" && (n(), document.removeEventListener("keydown", r), document.removeEventListener(ne, a))
            };
            document.addEventListener(ne, a)
        };

        function Rt(t) {
            var e = new RegExp("(^| )".concat(t, "=([^;]+)")), n = document.cookie.match(e);
            return n ? n[2] : ""
        }
        ...
        var xn = function () {
                var t = g(function (e) {
                    ...
                    return p(this, function (a) {
                        switch (a.label) {
                            case 0:
                                return n = In(e), r = {}, Ae(function (i) {
                                    Object.assign(r, i)
                                }), [4, Promise.race([Ue(6e4), ke()])];
                            case 1:
                                return a.sent(), [2, D({}, n, r)]
                        }
                    })
                });
                return function (n) {
                    ...
                    return p(this, function (a) {
                        switch (a.label) {
                            case 0:
                                return [4, xn(n)];
                            case 1:
                                return r = a.sent(), e(r, "page_speed"), [2]
                        }
                    })
                });
                return function (n, r) {
            ...
            kn = function (t) {
                ...
                if (P(t, HTMLImageElement)) {
                    var e = t.naturalHeight, n = t.naturalWidth, r = t.width, a = t.height;
                    return {naturalHeight: e, naturalWidth: n, width: r, height: a}
                }
                var i = t.getBoundingClientRect(), o = Math.floor(i.width), u = Math.floor(i.height);
                return {naturalHeight: u, naturalWidth: o}
            }, qn = function () {
                var t = g(function (e, n) {
                    var r, a, i, o, u, s, c, d, m, w, y, I, jt, Pe, qt, Re, se, Qt;
                    return p(this, function (dr) {
                        r = Fn(n, e.name), a = Bn(n), i = n.getAttribute("data-loader"), o = n.getAttribute("elementtiming"), u = e.toJSON(), s = u.serverTiming, c = u.workerTiming, d = K(u, ["serverTiming", "workerTiming"]), m = !0, w = !1, y = void 0;
                        try {
                            for (I = Object.entries(d)[Symbol.iterator](); !(m = (jt = I.next()).done); m = !0) Pe = C(jt.value, 2), qt = Pe[0], Re = Pe[1], typeof Re == "number" && (d[qt] = Math.floor(Re))
                        } catch (Ne) {
                            w = !0, y = Ne
                        } finally {
                            try {
                        ...
                        return se = Hn(n, e.name, a), Qt = jn(se), [2, new Promise(function (Ne) {
                            var Yt = new IntersectionObserver(function (sr) {
                                sr.forEach(function (fe) {
                                    if (fe.target === se) return Yt.disconnect(), Ne(D({
                ...
                var t = g(function (e) {
                    ...
                    return p(this, function (u) {
                        switch (u.label) {
                            case 0:
                                return n = e.resource, r = e.deliverMetrics, !(P(n, PerformanceResourceTiming) && n.initiatorType === "img") || !kn(n.name) ? [2] : (a = n.name.replace(/\?.*/, ""), i = Array.from(document.querySelectorAll('img[src="'.concat(n.name, '"], img[data-src*="').concat(a, '"], img[srcset*="').concat(n.name, '"]'))), document.querySelectorAll('picture > source[srcset*="'.concat(n.name, '"]')).forEach(function (s) {
                ...
                var t = g(function (e) {
                    ...
                    return p(this, function (a) {
                        return Nt() ? (n = function (i) {
                            return Qn({resource: i, deliverMetrics: e})
                        }, performance.getEntriesByType("resource").forEach(n), r = new PerformanceObserver(function (i) {
                            i.getEntries().forEach(n)
                        }), r.observe({entryTypes: ["resource"]}), [2]) : [2]
                    })
                });
                return function (n) {
                    return t.apply(this, arguments)
                ...
                var e = t.spanName, n = t.tracer, r = t.startTime, a = t.spanAttributes, i = a === void 0 ? {} : a;
                Y === void 0 && (Y = new Map);
                var o = n.startSpan(e, {startTime: r});
                o.setAttributes(i), Y.set(e, o)
            }, It = function (t) {
                var e = t.spanName, n = t.spanAttributes, r = n === void 0 ? {} : n, a = t.updateName;
                if (!(Y === void 0 || !Y.has(e))) {
                    var i = Y.get(e);
                    i.setAttributes(r), a !== void 0 && i.updateName(a), i.end(), Y.delete(e)
                }
            }, X = "rum-", xt = function (t) {
                var e, n;
        ...
        function Yn(t) {
            ...
            try {
                ...
                var r = window.performance.mark(n, {detail: e.detail, startTime: e.startTime});
                if (e.tracer !== void 0) {
                    var a = C(window.performance.getEntriesByName(n, "mark").slice(-1), 1), i = a[0];
                    Ce({spanName: n, tracer: e.tracer, startTime: i.startTime, spanAttributes: e.spanAttributes})
                }
                return r
            } catch (o) {
                xt(o)
        ...
        function Vn(t) {
            var e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {requireStart: !1};
            try {
                if (!(Dt() && Wn())) return;
                var n = X + t, r = {detail: e.detail, duration: e.duration};
                if (e.start === void 0 ? window.performance.getEntriesByName(n, "mark").length > 0 && (r.start = n) : typeof e.start == "string" ? r.start = X + e.start : r.start = e.start, r.end = typeof e.end == "string" ? X + e.end : e.end, e.requireStart && typeof r.start != "string") return;
                if (e.tracer !== void 0) {
                    var a = D({measureName: n}, e.spanAttributes);
                    if (typeof r.start == "number") Ce({
                        spanName: n,
                        tracer: e.tracer,
                        startTime: r.start
                    }), It({spanName: n, spanAttributes: a}); else {
                        var i;
        ...
        function Gn(t, e) {
            try {
                ...
                var n = typeof e.start == "string" ? e.start : t, r = typeof e.end == "string" ? e.end : void 0;
                try {
                    window.performance.measure(t, n, r)
                } catch (i) {
                    if (!P(i, DOMException)) throw i;
                    try {
                        window.performance.measure(t, "navigationStart")
                    } catch (o) {
                        if (!P(o, DOMException)) throw o;
                ...
                var e = function (r) {
                    ...
                    a.forEach(function (i) {
                        if (!(i.name && !Xn(i.name))) {
                            ...
                            Ut.has(o) || (t(i, "user"), Ut.add(o))
                        }
                    })
                };
                if (e(window.performance.getEntriesByType("measure")), Nt()) {
                    var n = new window.PerformanceObserver(function (r) {
                        return e(r.getEntries())
                    });
                    n.observe({entryTypes: ["measure"]})
                } else document.addEventListener(ne, function () {
        ...
        function $n(t) {
            window.addEventListener(zt, function () {
                ...
                document.visibilityState === "hidden" && (window.clearTimeout(kt), Bt(t))
            })
        }
        ...
        var tr = function (t, e) {
            return function (n, r) {
                var a = {app: t, data: n, event: r, pageLoadId: e, ts: Date.now()};
                er(a)
            }
        }, nr = function (t) {
            return function () {
                ...
                return p(this, function (a) {
                    switch (a.label) {
                        ...
                        case 1:
                            n = a.sent().nanoid();
                            try {
                                r = tr(e.appName, n), Dn(r, e.context), Kn(r), Mt(r), On(r), $n(e.serviceURL)
                            } catch (i) {
                                e.captureException(i, {pageLoadId: n, parsedOptions: e})
                            }
                            return [2]
                    }
                })
        ...
        var ar = {
            ...
            var t = /^qa\d+.sqsp.net/g, e = /^stage.sqsp.net/g,
            ...
            return new t({customSchemaName: "Performance", sourceEnvironment: e}, ar)
        }, Ht = Object.freeze({
            ...
            var t = g(function (e) {
                ...
                return p(this, function (r) {
                    switch (r.label) {
                        case 0:
                            return n = {}, Ae(function (a) {
                                Object.entries(a).forEach(function (i) {
                                    var o = C(i, 2), u = o[0], s = o[1];
        ...
        function cr() {
            ...
            return console.warn("@sqs/rum-collector default export is deprecated. Use named export `init` instead."), Ft.apply(void 0, b(e))
        }
    }
}, x => {
    var _ = L => x(x.s = L), A = _(136126)
}]);

//# sourceMappingURL=https://sourcemaps.squarespace.net/universal/scripts-compressed/sourcemaps/1951c8787cfa91965f020a0cc95ba3f5/performance-d9f618c1beaea97b6499-min.en-US.js.map